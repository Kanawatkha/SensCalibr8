    ...
    public sealed class P1R3SqliteSchemaTests
    {
        ...
        public void MigrationCreatesTheCompleteTableSetAndVersionMetadata()
        {
            ...
            CollectionAssert.AreEquivalent(new[]
            {
                ...
                "significance_tests", "significance_test_pairs", "phase_history", "injury_risk_flags"
            }, tables);
            ...
            Assert.That(Scalar(connection, "SELECT COUNT(*) FROM sqlite_master WHERE type='index' AND sql IS NOT NULL;"), Is.EqualTo(23));
        }
        ...
        public void EveryDeclaredForeignKeyCascadesOnDelete()
        {
            ...
            Assert.That(foreignKeyCount, Is.EqualTo(33));
        }
        ...
        public void BootstrapSeedsAllTwentyAcceptedCalibrationFieldsAndIsIdempotent()
        {
            ...
            Assert.That(Scalar(connection, "SELECT COUNT(*) FROM schema_migrations;"), Is.EqualTo(1));
        }
